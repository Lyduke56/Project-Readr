    ...
    <div className="bg-[#f4f7f2] flex flex-row justify-center w-full h-[100vh]">
      ...
      <div className="bg-[#f4f7f2] overflow-hidden w-[1440px] h-[calc(100vh-100px)] relative top-[100px]">
        ...
        <div className="absolute w-[385px] h-[750px] top-[50px] left-[41px] bg-white shadow-[0px_4px_4px_3px_#00000040]">
          <div className="absolute w-[336px] h-[169px] top-[207px] left-[25px]">
          ...
          <InputField
            className="!flex !absolute !left-[57px] !w-[272px] !top-[400px]"
            label="Password"
            state="default"
          ...
          <ButtonGroup
            ...
            buttonLabel="Sign In"
            buttonStart={false}
            className="!absolute !left-[57px] !w-[272px] !top-[494px]"
          />

          <TextLink
            className="!flex !absolute !left-[125px] !w-[136px] !top-[558px]"
